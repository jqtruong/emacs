...
(defvar my-packages '(ace-jump-buffer ace-jump-mode auto-dim-other-buffers base16-theme cljsbuild-mode cider clojurescript-mode dic-lookup-w3m etags-select expand-region geiser gitconfig-mode github-browse-file gitignore-mode helm helm-ls-git highlight-parentheses hlinum inf-mongo jabber jade-mode js-comint json-mode json-reformat json-snatcher jsx-mode less-css-mode love-minor-mode lua-mode magit-gh-pulls gh logito magit-push-remote mongo multiple-cursors neotree nodejs-repl dash clojure-mode ob-mongo org-magit org paradox pastebin pcache pkg-info epl pomodoro powerline quack racket-mode request s scheme-complete show-css starter-kit starter-kit-bindings starter-kit-eshell starter-kit-lisp dom elisp-slime-nav magit git-rebase-mode git-commit-mode ido-ubiquitous smex find-file-in-project idle-highlight-mode paredit stem sws-mode tabulated-list twittering-mode undo-tree w3m web-mode names shell-switcher))
